...
static esp_err_t event_handler( void *ctx,
...
static void sc_callback( smartconfig_status_t status,
						 void *pdata )
{
	switch( status )
	{
...
esp_err_t prxSerializeWifiNetworkProfile( const WIFINetworkProfile_t * const pxNetwork,
										  uint8_t *pucBuffer,
										  uint32_t * pulSize )
{
...
esp_err_t prxDeSerializeWifiNetworkProfile( WIFINetworkProfile_t * const pxNetwork,
											uint8_t *pucBuffer,
											uint32_t ulSize )
{
esp_err_t xRet = ESP_OK;
...
esp_err_t prvStoreWIFINetwork( nvs_handle xNvsHandle,
							   const WIFINetworkProfile_t * pxNetwork,
							   uint16_t usIndex )
{
uint32_t ulSize = 0;
uint8_t *pucBuffer;
...
esp_err_t prvGetWIFINetwork( nvs_handle xNvsHandle,
							 WIFINetworkProfile_t * pxNetwork,
							 uint16_t usIndex )
{
uint32_t ulSize = 0;
...
static esp_err_t WIFI_SetSecurity( WIFISecurity_t securityMode,
